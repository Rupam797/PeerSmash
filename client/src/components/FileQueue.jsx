...
function getFileIcon(mimeType = '') {
  if (mimeType.startsWith('image/')) return <Image size={18} color="var(--brand-mint)" />;
  if (mimeType.startsWith('video/')) return <Video size={18} color="var(--brand-mint)" />;
  ...
  if (mimeType.includes('pdf') || mimeType.includes('text') || mimeType.includes('document')) return <FileText size={18} color="var(--brand-mint)" />;
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                  {item.status === 'completed' && (
                    <span style={{ color: 'var(--brand-mint)', fontSize: '0.8rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
                  ...
                  {item.status === 'sending' && (
                    <span style={{ color: 'var(--brand-mint)', fontSize: '0.8rem', fontWeight: 700 }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', overflow: 'hidden' }}>
                  ...
                  <div style={{ overflow: 'hidden' }}>
                    ...
                    <div style={{ fontSize: '0.75rem', color: 'var(--brand-mint)', fontWeight: 600 }}>
